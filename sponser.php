...
if(isset($_POST['submit'])){
  ...
  $sql="insert into `sponsore` (name,email,address,input,city,area,mobile)
  values('$name','$email','$address','$input','$city','$area','$mobile')";

  $result=mysqli_query($con, $sql);

  if($result){
    echo "<script>alert('Thanks for your Sponsore')</script>";
                  ...
                  <form action="" method="POST" class="mx-1 mx-md-4">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-group mb-4">
                        ...
                        <input type="text" name="address" class="form-control" id="inputAddress2" placeholder="your address"required >
                        <label for="inputAddress2">Adress</label>
                      </div>
                      <div class="form-inline mb-4">   
                      <select class="custom-select" id="inlineFormCustomSelectPref" name="input">
                            <option selected>Choose...</option>
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                        </select>
                        <label class="my-1 mr-2" for="inlineFormCustomSelectPref">How many would you like to sponser?</label>
                      </div>
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <button type="submit" name="submit" class="btn btn-primary btn-lg">sponsore</button>
                    </div>
