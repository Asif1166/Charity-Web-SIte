                  ...
                  <form action="" method="POST" class="mx-1 mx-md-4">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-group mb-4">
                        ...
                        <input type="text" name="food" class="form-control" id="inputAddress2" placeholder="Rice,potato,oil etc"required >
                        <label for="inputAddress2">Which Food</label>
                      </div>
                      ...
                      <select class="custom-select" id="inlineFormCustomSelectPref" name="quantity" >
                            ...
                            <option value="3">More than above</option>
                        </select>
                        <label class="my-1 mr-2" for="inlineFormCustomSelectPref">How many would you like to give?</label>
                      </div>
